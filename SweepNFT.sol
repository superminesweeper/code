...
contract SweepNFT is ERC721Enumerable, Ownable {
    ...
    bool public can_activated = true;
    ...
    function setActivatedStatus(bool can_activated_) external onlyOwner() {
        can_activated = can_activated_;
    }
    ...
    function createNft(uint256 tokenId_, uint256 width_, uint256 height_, uint256[] memory points_,
        ...
        require(can_activated == true, 'NFT cannot be activated temporarily');
        ...
        if (coin > 0) _Token.burnToZero(msg.sender, coin);
